...
/*!*******************************************!*\
  !*** ./src/forum/components/ChatFrame.js ***!
  \*******************************************/
/*! exports provided: ChatMessage, ChatFrame */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChatMessage", function() { return ChatMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChatFrame", function() { return ChatFrame; });
...
function (_Component) {
  ...
  _proto.controller = function controller(data, b, c) {
  ...
  _proto.getChat = function getChat(el) {
  ...
  _proto.getInput = function getInput(chat) {
    if (!this.input) {
  ...
  _proto.toggle = function toggle(ctrl, e) {
  ...
  _proto.toggleSound = function toggleSound(ctrl, e) {
  ...
  _proto.toggleNotifications = function toggleNotifications(ctrl, e) {
  ...
  _proto.insertReference = function insertReference(user, e) {
    // Get the chat div from the event target
    var chat = this.getChat(e.target); // Find the input element

    var input = this.getInput(chat); // Insert text

    input.value = input.value + " @" + user.username() + " ";
    input.focus();
  };

  _proto.reachedLimit = function reachedLimit(ctrl) {
    ctrl.oldReached = maxLength - (ctrl.oldlength || 0) < 100;
    return ctrl.oldReached;
  };

  _proto.refocus = function refocus(ctrl, e) {
    this.input = e;
  ...
  _proto.parseMessage = function parseMessage(e) {
    s9e.TextFormatter.preview(e.dataset.message, e);
  };

  _proto.scroll = function scroll(ctrl, e) {
  ...
  _proto.disableAutoScroll = function disableAutoScroll(ctrl, e) {
    var el = e.target;
    ctrl.scrollInfo.autoScroll = el.scrollTop + el.offsetHeight >= el.scrollHeight;
    var currentHeight = el.scrollHeight; // Load older messages
  ...
  _proto.view = function view(ctrl, args) {
    for (var i = 0; i < args.forward.length; ++i) {
      this.forwardMessage(ctrl, args.forward[i], false);
    }

    return m('div', {
      className: 'chat left container ' + (ctrl.beingShown ? '' : 'hidden')
    }, [m('div', {
      tabindex: 0,
      className: 'frame',
      id: 'chat',
      ...
      id: 'chat-header',
      onclick: this.toggle.bind(this, ctrl)
    }, [m('h2', app.translator.trans('pushedx-chat.forum.toolbar.title')), m('p', {
    ...
    })])]), ctrl.loading ? flarum_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      className: 'loading Button-icon'
    }) : m('span'), m('div', {
      className: 'wrapper',
      config: this.scroll.bind(this, ctrl),
      onscroll: this.disableAutoScroll.bind(this, ctrl)
    }, [ctrl.loadingOld ? m('div', {
      className: 'message-wrapper'
    }, [m('span', {
      className: 'message'
    }, flarum_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      className: 'loading-old Button-icon'
    })), m('div', {
      className: 'clear'
    })]) : undefined, ctrl.messages.map(function (o) {
      return m('div', {
        className: 'message-wrapper',
        title: o.created_at
      }, [m('span', {
        className: 'avatar-wrapper',
        'data-name': o.user ? o.user.username() : 'Loading...'
      }, flarum_helpers_avatar__WEBPACK_IMPORTED_MODULE_4___default()(o.user, {
        className: 'avatar',
        onclick: this.insertReference.bind(this, o.user)
      })), m('span', {
        className: 'message',
        'data-message': o.message,
        config: this.parseMessage.bind(this)
      }), m('div', {
        className: 'clear'
      })]);
    }.bind(this))]), m('input', {
  ...
  _proto.process = function process(ctrl, e) {
  ...
  _proto.checkLimit = function checkLimit(ctrl, e) {
    var redraw = false;
    var now = +new Date();

    if (!ctrl.lastChecked || now > ctrl.lastChecked + 50) {
      ctrl.lastChecked = now; // Save length
  ...
  _proto.failure = function failure(ctrl, message) {
    // todo show popup
    ctrl.loading = false;
    m.redraw();
  };
  ...
  _proto.success = function success(ctrl, response) {
    // End loading
    ctrl.loading = false; // Redraw now

    m.redraw();
  };

  _proto.forwardMessage = function forwardMessage(ctrl, message, notify, redraw) {
  ...
  _proto.addMessage = function addMessage(ctrl, id, msg, user, created_at, notify, redraw) {
    // Do note "messages" is a "set", thus = is a function
    var obj = new ChatMessage(id, user, msg, created_at);
    ctrl.messages.push(obj); // End loading
  ...
  _proto.notify = function notify(ctrl, msg) {
    if (ctrl.notify) {
  ...
  _proto.notifySound = function notifySound(ctrl, msg) {
    if (!ctrl.isMuted) {
...
/* harmony import */ var _models_ChatMessage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/ChatMessage */ "./src/forum/models/ChatMessage.js");
...
var extend = [new _flarum_core_forum__WEBPACK_IMPORTED_MODULE_4__["Extend"].Model('chat-messages', _models_ChatMessage__WEBPACK_IMPORTED_MODULE_3__["default"])];
app.initializers.add('pushedx-realtime-chat', function (app) {
  var forward = [];
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_HeaderPrimary__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'config', function (x, isInitialized, context) {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_HeaderPrimary__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'items', function (items) {
    ...
    */
    ...
    items.add('pushedx-chat-frame', m.component(new _components_ChatFrame__WEBPACK_IMPORTED_MODULE_2__["ChatFrame"](), {
      forward: forwarded
    }));
...
/***/ "./src/forum/models/ChatMessage.js":
/*!*****************************************!*\
  !*** ./src/forum/models/ChatMessage.js ***!
  \*****************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function (_mixin) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(ChatMessage, _mixin);
  ...
  message: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('message'),
  ...
  userId: flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('actorId')
}));
